...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								...
								<div class="actions">
								<!--  -->
									<button id="sample_editable_1_new" onclick="location.href='${pageContext.request.contextPath}/go.action'" class="btn red">
	...
	<script type="text/javascript">
		...
		/*$("#sample_editable_1_new").click(function(){
			//alert("你大爷");
			window.location.href="${pageContext.request.contextPath}/go.action";

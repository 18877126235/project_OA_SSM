...
<html lang="cn">
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/media/css/search.css" rel="stylesheet"
			type="text/css" />
				...
				<div class="container-fluid">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<!-- BEGIN 网页的标题和面包屑-->
							<h3 class="page-title">
								<strong> 出差管理<small>添加出差记录</small> </strong>
							</h3>
							<ul class="breadcrumb">
								<li>
									<strong> <a href="${pageContext.request.contextPath}/index.jsp">我的桌面</a> <a
										href="${pageContext.request.contextPath}/hrm/findAllEvections.action">出差管理</a> 添加出差记录</strong>
								</li>
							</ul>
							<!-- END 网页的标题和面包屑-->
						</div>
						...
						<div class="span12">
							...
							<div class="portlet box blue">
								...
								<div class="portlet-body form">
									<!-- BEGIN FORM-->
									<form id="frm" action="${pageContext.request.contextPath}/hrm/insertEvection.action" method="post"  class="form-horizontal">
											...
											<div class="span6 ">
												<div class="control-group">
													...
													<div class="controls">
														<strong>
														    <select 
																name="emp.empId" class="m-wrap span6">
																<c:forEach items="${emps}" var="emp">
																    <option value="${emp.empId}">${emp.empNumber }</option>
																</c:forEach>
															</select> 
													    </strong>
													</div>

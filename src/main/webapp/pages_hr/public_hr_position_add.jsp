									...
									<td>
										<!-- begin操作按钮 -->
											<div class="btn-group" style="margin-bottom: 0px !important;">
												...
												<li><a href="#" id = "deletePoss" class="btn mini green user_del" title="${obj.posId }" ><i class="icon-trash"></i>删除</a></li>
				...
				swal(
					{
						...
						window.location.href = "${pageContext.request.contextPath}/pages_hr/deletePosition.action?positionId=" + cId;
					});	
			});
		});
	</script>

		...
		<script type="text/javascript">
		     $(function(){
		         $("#frm").submit(function(){
		               ...
		               var empPhotoUrl = $("input[name='empPhotoUrl']").val();
		               if(empPhotoUrl==""){
			                  alert("请选一张图片作为图像");
			                  return false;
		               }
			           ...
			           var empBrithday = $("input[name='empBrithday']").val();
			           if(empBrithday==""){
			               alert("出生日期不能为空!");
			               return false;
			           }
			           
			           var empTelephone = $("input[name='empTelephone']").val();
			           if(empTelephone==""){
			              alert("电话不能为空!");
			              return false;
			           }
			           ...
			           var empEntryDate = $("input[name='empEntryDate']").val();
			           if(empEntryDate==""){
			               alert("入职日期不能为空!");
			               return false;
			           }
...
.file:hover {
	...
	<body class="page-header-fixed">
				...
				<div class="container-fluid">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<!-- BEGIN 网页的标题和面包屑-->
							<h3 class="page-title">
								<strong> 员工<small>添加员工</small> </strong>
							</h3>
							<ul class="breadcrumb">
								<li>
									<strong> <a href="${pageContext.request.contextPath}/index.jsp"></a> <a
										href="${pageContext.request.contextPath}/hrm/getEmployeeByPage.action">员工管理</a> 添加员工</strong>
								</li>
							</ul>
							<!-- END 网页的标题和面包屑-->
						</div>
						...
						<div class="span12">
							...
							<div class="portlet box blue">
								...
								<div class="portlet-body form">
									<!-- BEGIN FORM-->
									<form  id="frm" action="${pageContext.request.contextPath}/hrm/insertEmployee.action" method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<div class="row-fluid">
											<div class="span6">
												<div class="control-group">
													<strong><label class="control-label">
															员工工号:
														</label> </strong>
													<div class="controls">
											...
											<div class="span6">
												<div class="control-group">
													...
													<img id="img" alt="" src="" style="width:248px">
													<div class="controls">
														<strong><a class="file">选择头像
																<input onchange="showImg(this.value)"
																	style="width: 1700px; height: 138px;" name="empPhotoUrl"
																	type="file" id="doc" /> </a> </strong>
													</div>
												</div>
											</div>
													...
													<div class="controls">
														<div class="input-append date date-picker"
															...
															<strong><input type="text" name="empBrithday"
																	...
																	placeholder="请选择" value=""> <span
																class="add-on"> </span> </strong>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="row-fluid">
											...
											<div class="span6 ">
												<div class="control-group">
													...
													<div class="controls">
														<strong><label class="radio">
																<input type="radio" name="empSex" value="男"
																	class="m-wrap span12" checked>
																先生
		...
		<script type="text/javascript"
			src="<%=basePath%>main_pages/selectposition.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>main_pages/selectparam.js"></script>
		<script>

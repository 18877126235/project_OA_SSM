...
public class User {
	...
	private Integer state;// 状态码（是否激活的状态）
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", userPassword=" + userPassword + ", emp=" + emp
				+ ", dep=" + dep + ", roles=" + roles + ", userEmail=" + userEmail + ", state=" + state + ", code="
				+ code + "]";
	}

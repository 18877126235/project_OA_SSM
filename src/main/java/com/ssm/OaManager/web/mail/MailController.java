...
public class MailController {
	...
	public String mailLogin(HttpServletRequest request) {
		...
		String mailAddr = request.getParameter("mailAddr"); //获取邮箱账号
		String mailPass = request.getParameter("mailPass"); //获取授权码
		...
		try {
			...
			session = sendMail.connectSMTP(userAuth, "SMTP"); //问题出在此处
